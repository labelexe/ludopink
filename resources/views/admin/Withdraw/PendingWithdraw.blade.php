              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                   ...
                   <td>
                        <button type="button" data-trans="{{$result->transaction_id}}" data-requestid="{{$result->id}}" data-pay="{{$result->payment_method}}" data-id="{{$result->userid}}" data-username="Jhone Doe" data-status="{{$result->status}}" data-toggle="modal" data-target="#addCoin" title="Edit" class="btn btn-icon btn-icon rounded-circle btn-primary bg-darken-4 border-0 edit_buuton">
